...
public:
    ...
    /**
     * Get the radius of the neighborhood for mean filter 1 for 3x3, 2 for 5x5 and 3 for 7x7
     * @return	Radius of the neighborhood for mean filter
     */
    unsigned int getMeanRadius() const;

    /**
     * Get the radius of the neighborhood for median filter 1 for 3x3, 2 for 5x5 and 3 for 7x7
     * @return	Radius of the neighborhood for median filter
     */
